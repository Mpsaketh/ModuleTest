const components = [
    {
      title: "rock",
      ring_img: "./img/Group 2.png",
      hand_img: "./img/rock.png",
    },
    {
      title: "scissor",
      ring_img: "./img/Group 3.png",
      hand_img: "./img/scissor.png",
    },
    {
      title: "paper",
      ring_img: "./img/Group 1.png",
      hand_img: "./img/paper.png",
    },
  ];
  ...
  const showNextBtn = () => {
    ...
    nextBtn.addEventListener("click", () => {
      ...
      <div class="hurray-imgs">
        ...
        <img class="trophy" src="img/Vector (1).png" alt="trophy">
      </div>
      <h1>hurray!!</h1>
